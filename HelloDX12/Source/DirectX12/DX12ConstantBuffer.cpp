...
void DX12ConstantBuffer::Init(DX12Context& ctx, uint32_t bufferSize)
{
...
void DX12ConstantBuffer::UploadData(void* data)
{
	memcpy(mappedData_, data, bufferSize_);
}

uint32_t DX12ConstantBuffer::GetConstantBufferByteSize(uint32_t byteSize)
{
