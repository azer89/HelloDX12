...
void PipelineSkybox::CreateRootSignature(DX12Context& ctx)
{
	...
	//ranges.emplace_back().Init(D3D12_DESCRIPTOR_RANGE_TYPE_CBV, 1, shaderRegister++, 0, D3D12_DESCRIPTOR_RANGE_FLAG_DATA_STATIC);
	...
	// Root signature
	descriptor_.CreateRootDescriptor(ctx, defaultSamplerDesc, rootParameters, rootSignatureFlags);
}
